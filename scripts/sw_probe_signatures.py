...
TARGETS = {
    IDrawingDoc: ["CreateSectionViewAt", "CreateSectionViewAt2",
                   ...
                   "ActivateView", "FeatureByName",
                   "CreateAlignedSectionView", "CreateAlignedSectionView2",
                   "CreateBrokenView", "CreateDetailViewAt",
                   "CreateDetailViewAt4", "InsertModelInDrawing",
                   "Create3rdAngleViews2", "CreateUnfoldedViewAt",
                   "CreateAuxiliaryViewAt5"],
